...
$CONFIG['CONFERENCE'] = array(
	 ...
	 */
	'STARTS_AT' => strtotime("2016-11-05 18:45"),
	 ...
	 */
	'ENDS_AT' => strtotime("2016-11-05 23:30"),
  ...
  'TITLE' => 'Logbuch Netzpolitik #200',
	 ...
	 * <meta>-Tag generiert.
	 */
	'AUTHOR' => 'Tim Pritlove und Linus Neumann',
	 ...
	 * <meta>-Tag generiert.
	 */
  'DESCRIPTION' => 'Der Geburtstag von Logbuch:Netzpolitik jährt sich Ende Oktober 2016 zum fünften Mal und wie es der Zufall will steht dann auch die 200. Sendung Logbuch:Netzpolitik an.

Zweihundertmal Nachrichten, Hintergründe, Einblicke und Ausblicke in das (netz-)politische Geschehen in Deutschland, Österreich, der Schweiz, Europa und der Welt.

Methodisch inkorrekt!Das alles wollen wir gemeinsam mit Euch gebührend feiern und laden zu einer ganz besonderen Gala nach Berlin, bei der es mehr zu sehen geben wird als nur eine ganz normale Sendung.

Als Unterstützung haben wir unsere Freunde von Methodisch Inkorrekt als Vorgruppe angeheuert.',
	 ...
	 */
	'FOOTER_HTML' => '
		by <a href="http://logbuch-netzpolitik.de/">Logbuch Netzpolitik</a>',
...
//	'BANNER_HTML' => "<div class='col-xs-12'><img src='../configs/conferences/geheimdienstevorgericht/logo.png'></img></div>",
	'BANNER_HTML' => "<h1>Logbuch Netzpolitk #200</h1>",
	 ...
	 * Wird diese Zeile auskommentiert, wird der Link nicht angezeigt
	 */
	'RELIVE_JSON' => 'configs/conferences/lnp200/vod.json',
);
...
$CONFIG['ROOMS'] = array(
	...
	's3' => array(
		 ...
		 * Angezeige-Name
		 */
    'DISPLAY' => "Ehemaliges Stummfilmkino Delphi",
		/**
