...
{
	$upcoming_afu = $upcoming_afus[0];
	preg_match('/^events:afu([0-9]+)$/i', $upcoming_afu['short_name'], $m);

	$EPISODE = intval($m[1]);
	$DATE = strtotime($upcoming_afu['start_date'].' 19:30');
	$TITLE = $upcoming_afu['name'];
}
...
$GLOBALS['CONFIG']['CONFERENCE'] = array(
	 ...
	 * <meta>-Tag generiert.
	 */
	'KEYWORDS' => 'Amateurfunk, Chaos Computer Club, Berlin, Video, Media, Streaming, Club Discordia',
	 ...
	 */
	//'RELEASES' => 'https://media.ccc.de/browse/events/afu/index.html',
