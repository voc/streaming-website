...
{
	$upcoming_oc = $upcoming_ocs[0];

	$DATE = strtotime($upcoming_oc['start_date'].' 20:00');
	$TITLE = $upcoming_oc['name'];
}
...
$CONFIG['CONFERENCE'] = array(
	 ...
	 * <meta>-Tag generiert.
	 */
	'DESCRIPTION' => 'Das OpenChaos ist die monatliche Vortragsveranstaltung des Chaos Computer Club Cologne.',
	 ...
	 * <meta>-Tag generiert.
	 */
	'KEYWORDS' => 'OpenChaos, Chaos Computer Club, Köln',
	 ...
	 */
	'FOOTER_HTML' => '
		by <a href="https://koeln.ccc.de">Chaos Computer Club Cologne e.V</a> &amp;
