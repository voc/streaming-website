...
$upcoming_r3talks = Upcoming::getNextEvents('/^realraum[0-9]*$/i');

if(count($upcoming_r3talks) < 1)
{
	$EPISODE = '???';
	$START_DATE = strtotime('1970-01-01 22:00');
	$END_DATE = $START_DATE + 60*90;
	$TITLE = 'r3talks';
}
else
{
	$upcoming_talk = $upcoming_r3talks[0];
	preg_match('/^realraum([0-9]+)$/i', $upcoming_talk['slug'], $m);
...
$CONFIG['CONFERENCE'] = array(
	 ...
	 */
	'STARTS_AT' => $START_DATE - 60*30, // -30 Minuten,
	 ...
	 */
	'ENDS_AT' => $END_DATE + 60*150, // +2½ Stunden,
	 ...
	 * <meta>-Tag generiert.
	 */
	'DESCRIPTION' => 'Die r3talks sind eine Veranstaltungsreihe des realraum in Graz.',
	 ...
	 * <meta>-Tag generiert.
	 */
	'KEYWORDS' => 'realraum, Graz, Video, Media, Streaming',
	 ...
	 */
	'FOOTER_HTML' => '
		by <a href="https://realraum.at/">realraum</a> &amp;
	 ...
	 */
	'BANNER_HTML' => "
		<img src='/configs/conferences/realraum/banner.jpg' alt=''>
	",
	 ...
	 */
	'RELEASES' => 'https://media.ccc.de/c/realraum',
	 ...
	 * Wird diese Zeile auskommentiert, wird der Link nicht angezeigt
	 */
	// 'RELIVE_JSON' => 'https://cdn.c3voc.de/relive/realraum/index.json',
);
	...
	'lothr' => array(
		...
		*/
		'TWITTER_CONFIG' => array(
			'DISPLAY' => '#r3talks @ twitter/mastodon',
			'TEXT'    => '#r3talks',
		),
	),
);
