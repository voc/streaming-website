...
$CONFIG['CONFERENCE'] = array(
	 ...
	 */
	'STARTS_AT' => strtotime("2016-09-29 10:00"),
	 ...
	 */
	'ENDS_AT' => strtotime("2016-09-30 19:00"),
	 ...
	 * <meta>-Tag generiert.
	 */
	'DESCRIPTION' => 'Since its start in early 2010 the systemd project — the system and service manager — has become a core component of modern Linux systems. systemd is the default init system on every major distribution and has been pushed forward by more than 600 contributors. Last year the first gathering dedicated to the project was held in the heart of Berlin\'s Kreuzberg district. Approximately 100 community members gathered for 2 days of talks and a 1-day hackfest. The feedback was clear that we should do it again, and preferably keep it in Berlin. systemd.conf 2016 is looking to build on the success of last year\'s event while keeping the same friendly, relaxed atmosphere. To that end, we will be in the same venue and are accommodating a slightly larger crowd. We\'ve also added an additional workshop day to the schedule for some hands-on sessions.',
	 ...
	 * <meta>-Tag generiert.
	 */
	'KEYWORDS' => 'systemd.conf, Open Source, Berlin, Betahaus, Video, Streaming, Live, Livestream',
...
$CONFIG['SCHEDULE'] = array(
	 ...
	 */
	'URL' => 'https://cfp.systemd.io/en/systemdconf_2016/public/schedule.xml',
